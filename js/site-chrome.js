...
(function () {
  ...
  var ICON_TRYHACKME = '<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><text x="50%" y="50%" dominant-baseline="central" text-anchor="middle" font-family="monospace" font-weight="700" font-size="7">THM</text></svg>';

...
(function () {
  ...
  var ICON_TRYHACKME = '<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M10.705 0C7.54 0 4.965 2.374 4.713 5.4 3.35 5.756 2.4 6.994 2.4 8.4c0 1.654 1.346 3 3 3h9.6c1.654 0 3-1.346 3-3 0-1.406-.95-2.644-2.313-3C15.435 2.374 12.86 0 9.695 0h1.01zm-.01 1.2c2.426 0 4.395 1.856 4.492 4.2H6.213c.097-2.344 2.066-4.2 4.482-4.2zM5.4 6.6h13.2c.993 0 1.8.807 1.8 1.8s-.807 1.8-1.8 1.8H5.4c-.993 0-1.8-.807-1.8-1.8S4.407 6.6 5.4 6.6zM6 11.4l1.5 10.2h9l1.5-10.2H6zm3.6 1.2h1.2v1.2H9.6v-1.2zm1.2 0h1.2v1.2h-1.2v-1.2z"/></svg>';
